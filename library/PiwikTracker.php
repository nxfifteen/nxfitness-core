<?php
    ...
    class PiwikTracker {
         ...
         * @param string|array $category (optional) Product category, or array of product categories (up to 5
         ...
         *                                   text
         * @param string|bool $contentTarget (optional) The target of the content. For instance the URL of a landing
         *                                   page.
         *
         ...
         * @param string       $contentPiece  The actual content. For instance the path to an image, video, audio, any
         *                                    text
         * @param string|false $contentTarget (optional) The target of the content. For instance the URL of a landing
         *                                    page.
         *
         ...
         * @param string       $contentPiece  The actual content. For instance the path to an image, video, audio, any
         *                                    text
         * @param string|false $contentTarget (optional) The target the content leading to when an interaction occurs.
         *                                    For instance the URL of a landing page.
         *
         ...
         * Items which were in the previous cart and are not sent in later Cart updates will be deleted from the cart
         * (in the database).
         *
         ...
         * reported in Piwik reports. Only the parameters $orderId and $grandTotal are required.
         *
         ...
         *                               different days, or the transaction will not be recorded by Piwik.
        ...
        /**
         * Enable Cookie Creation - this will cause a first party VisitorId cookie to be set when the VisitorId is set
         * or reset
         *
         * @param string $domain (optional) Set first-party cookie domain. Accepted values: example.com, *.example.com
         ...
         * If scope is 'visit', it will attempt to read the value set in the first party cookie created by Piwik
         * Tracker ($_COOKIE array).
         *
         ...
         * your system. A User ID can be a username, UUID or an email address, or any number or string that uniquely
         * identifies a user or client.
         *
         ...
         * Rather than letting Piwik attribute the user with a heuristic based on IP and other user fingeprinting
         * attributes, force the action to be recorded for a particular visitor. If you use both setVisitorId and
         * setUserId, setUserId will take precedence. If not set, the visitor ID will be fetched from the 1st party
         * cookie, or will be set to a random UUID.
         *
