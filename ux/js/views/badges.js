$(function () {
    ...
    if (myBadges.length > 0) {
        $.getJSON("../json.php?user=" + fitbitUserId + "&data=Badges", function (data) {
            var html = '', htmlBadges, badgeGradientStartColor, badgeGradientEndColor, last_badge, last_badge_name, last_badge_marketingdescription;
