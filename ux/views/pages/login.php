                    ...
                    <div class="card-block">
                        ...
                        <form action="<?php echo $config['http/admin']; ?>/login/redirect" method="post">
                            <div class="input-group mb-3">
                                    ...
                                    </span> <input type="text" class="form-control" placeholder="Username" name="fuid"
                                                   autofocus>
                            </div>
                ...
                <div class="card card-inverse card-info py-5 d-md-down-none" style="width:22%">
                    <div class="card-block text-center">
                        <div>
                            ...
                            <a class="btn btn-info active mt-3"
                               href="https://nxfifteen.me.uk/gitlab/nx-fitness/nxfitness-core/wikis/beta-access-request"
                               target="_blank">BETA Access FAQ</a>
                        </div>
                    </div>
                </div>
            </div>
