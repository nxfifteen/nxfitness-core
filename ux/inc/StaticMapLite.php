...
Class StaticMapLite
{
    ...
    protected $markerBaseDir = '../img/markers';
    protected $osmLogo = '../img/osm_logo.png';
    ...
    protected $markerPrototypes = [
        ...
        'ol-marker' => [
            'regex' => '/^ol-marker(|-blue|-gold|-green)+$/',
            'extension' => '.png',
    ...
    public function parseOjwParams()
    {
        ...
        if (!empty($_GET['mlat0'])) {
            ...
            if (!empty($_GET['mlon0'])) {
                ...
                $this->markers[] = ['lat' => $markerLat, 'lon' => $markerLon, 'type' => "bullseye"];
            }
        }
    }
    ...
    public function placeMarkers()
    {
        ...
        foreach ($this->markers as $marker) {
            ...
            // calc position
            $destX = floor(($this->width / 2) - $this->tileSize * ($this->centerX - $this->lonToTile($markerLon,
                        $this->zoom)));
            ...
            imagecopy($this->image, $markerImg, $destX + intval($markerImageOffsetX),
    ...
    public function copyrightNotice()
    {
        ...
        imagecopy($this->image, $logoImg, imagesx($this->image) - imagesx($logoImg),
            imagesy($this->image) - imagesy($logoImg), 0, 0, imagesx($logoImg), imagesy($logoImg));
