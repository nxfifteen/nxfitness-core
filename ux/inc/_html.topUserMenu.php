...
<ul class="nav navbar-nav ml-auto">
    ...
    <li class="nav-item d-md-down-none">
        <a class="nav-link" href="#"><i class="line-icon-bell"></i><span
                    class="badge badge-pill badge-danger"><?php echo count($HeaderNotificationBar); ?></span></a>
    </li>
    <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
           aria-expanded="false">
            <img src="<?php echo $userProfile['avatar']; ?>" class="img-avatar"
                 alt="<?php echo $userProfile['name']; ?>"> <span
                    class="d-md-down-none"><?php echo $userProfile['name']; ?></span> </a>
        <div class="dropdown-menu dropdown-menu-right">
            ...
            <a class="dropdown-item" href="#"><i class="fa fa-bell-o"></i> Updates<span
                        class="badge badge-info"><?php echo count($HeaderNotificationBar); ?></span></a>
            ...
            <a class="dropdown-item" href="#"><i class="fa fa-user"></i> Profile</a> <a class="dropdown-item"
                                                                                        href="#"><i
                        class="fa fa-wrench"></i> Settings</a> <a class="dropdown-item" href="refresh"><i
